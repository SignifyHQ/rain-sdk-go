...
// interacting with the rain API. You should not instantiate this client directly,
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("RAIN_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("RAIN_CUSTOM_HEADERS"); ok {
...
// environment (RAIN_API_KEY, RAIN_BASE_URL). The option passed in as arguments are
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Signatures = NewSignatureService(opts...)
