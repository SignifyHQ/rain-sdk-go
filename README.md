...
<a href="https://pkg.go.dev/github.com/SignifyHQ/rain-sdk-go"><img src="https://pkg.go.dev/badge/github.com/SignifyHQ/rain-sdk-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/SignifyHQ/rain-sdk-go@v0.0.2'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/SignifyHQ/rain-sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/SignifyHQ/rain-sdk-go/issues) with questions, bugs, or suggestions.
