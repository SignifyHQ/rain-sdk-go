...
<a href="https://pkg.go.dev/github.com/stainless-sdks/rain-hello-world-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/rain-hello-world-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Rain Go library provides convenient access to the Rain REST API
...
```go
import (
	"github.com/stainless-sdks/rain-hello-world-go" // imported as rainhelloworld
)
```
...
```sh
go get -u 'github.com/stainless-sdks/rain-hello-world-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/rain-hello-world-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/rain-hello-world-go/issues) with questions, bugs, or suggestions.
