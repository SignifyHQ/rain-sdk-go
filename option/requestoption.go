...
// RequestOption is an option for the requests made by the rain API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/rain-hello-world-go#readme-requestoptions
...
func WithEnvironmentDev() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api-dev.raincards.xyz/v1/issuing/")
}
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.raincards.xyz/v1/issuing/")
}
